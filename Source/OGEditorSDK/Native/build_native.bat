...
REM Output: bin\Release\net8.0\win-x64\publish\ogeditor_api.dll
REM
REM Requirements:
...
REM Copy ogeditor_api.dll + ogeditor_api.h to your editor's plugin directory.
...
echo Header:  ogeditor_api.h  (copy alongside the .dll)
echo.
pause
